...
// import { Col, Container, FormCheck, Row, Form, } from "react-bootstrap";
// import "./Login1.css";
...
//     axios({
//       url: `http://rideezy-env.eba-ipiwpram.ap-south-1.elasticbeanstalk.com/api/users/getUserById/18`,
//       method: "GET",
//     })
//       .then((res) => {
...
//     setload(false);
//     axios({
//       url: `http://rideezy-env.eba-ipiwpram.ap-south-1.elasticbeanstalk.com/api/users/18`,
//       method: "PUT",
//       headers: {
//         Authorization: `Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJzYWdhcmJhdHR1bC5TQkBnbWFpbC5jb20iLCJpYXQiOjE2NjM0MzM5NTR9.-RS_KTka-bbjZIgPzQWI36ISqD34Y4PSnXAMwITVATYXMqbzhtKOL424-YNA6bq1a-dvv-dg7WHJp_90Zpo7JQ`,
//       },
...
//         password: inputdata.Password || "12345678",
//       },
//     })
//       .then((res) => {
